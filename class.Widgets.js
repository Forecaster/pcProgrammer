function Widgets(baseDir)
{
  ...
  this.widget["conditionDroneRF"]                   = {sprite: "conditionDroneRFPiece.png"              ,width: 80, height: 64,  name: "Drone Condition: RF"         , confModules: [], confModulesLeft: [], confModulesRight: [],                                                    desc: ""};
  ...
  this.widget["conditionRF"]                        = {sprite: "conditionRFPiece.png"                   ,width: 80, height: 108, name: "Condition: RF"               , confModules: [], confModulesLeft: [], confModulesRight: [],                                                    desc: ""};
  ...
  this.widget["rfExport"]                           = {sprite: "RFExportPiece.png"                      ,width: 80, height: 64,  name: "Export RF"                   , confModules: [], confModulesLeft: [], confModulesRight: [],                                                    desc: ""};
  this.widget["rfImport"]                           = {sprite: "RFImportPiece.png"                      ,width: 80, height: 64,  name: "Import RF"                   , confModules: [], confModulesLeft: [], confModulesRight: [],                                                    desc: ""};
